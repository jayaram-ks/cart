...
<!--      <li class="header">HEADER</li>-->
      ...
      <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="{{route('admin.managecategory')}}"><i class="fa fa-caret-right"></i>Categories</a></li>
          <li><a href="#"><i class="fa fa-caret-right"></i>Manufacturers</a></li>
          <li><a href="{{route('admin.manageproduct')}}"><i class="fa fa-caret-right"></i>Products</a></li>
        </ul>
      </li>


       <li class=""><a href="#"><i class="fa fa-user"></i> <span>CUSTOMERS</span></a></li>
       <li class="treeview">
        ...
        <ul class="treeview-menu">
          <li><a href="#"><i class="fa fa-caret-right"></i>Orders</a></li>
